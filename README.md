...
Note: any reduced images have been saves as the original file name + "_min" to indicated the smaller size is used. Look for that suffix in my code for areas where images optimization has been applied.
